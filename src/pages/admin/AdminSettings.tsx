...
import { Settings, CreditCard, Percent, Shield } from 'lucide-react';
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    min="0"
                    value={settings.protectionPlanFee}
                    onChange={(e) => setSettings({ ...settings, protectionPlanFee: Number(e.target.value) })}
                    className="max-w-xs"
                  />
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setSettings({ ...settings, minRentalDuration: Number(e.target.value) })}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setSettings({ ...settings, maxRentalDuration: Number(e.target.value) })}
                    />
                  </div>
                </div>
